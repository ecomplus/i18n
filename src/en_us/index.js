...
export const i19aboutCvv = '3 or 4 digits, usually on the back of the card (up front on AMEX cards)'
...
export const i19addPref = 'Add to preferences'
export const i19addToPrice = 'Add to price'
export const i19addVariationText = 'Add variants if the product has different versions and grids, such as sizes or colors'
export const i19adminSettings = 'Admin Settings'
export const i19adRelevance = 'Number to define the importance of the ad, the higher should be displayed first'
export const i19adType = 'Option ad type defined by seller, such as gold and silver'
...
export const i19alterationPrice = 'Default price alteration on products with this grid for customization or variations.'
...
export const i19authorizedStores = 'IDs from other stores authorized to sell this product'
...
export const i19budgetOnly = 'If order is only budget without transaction'
...
export const i19channelId = 'Channel unique identifier'
export const i19channels = 'Channels'
export const i19channelType = 'Channel type'
export const i19checkout = 'Buy now'
...
export const i19contactUs = 'If you have any questions, please contact us.'
...
export const i19customizationsAddToPrice = 'Price alteration due to this customization'
export const i19customizationsAttachment = 'URL of file attached by customer to this field'
export const i19customizationsLabel = 'Label of customization'
export const i19customizationsOption = 'Option chosen or created by customer'
export const i19customValue = 'Custom value'
export const i19customer = 'Customer'
export const i19customerNotified = 'If customer was already notified of this event'
export const i19dashboard = 'Dashboard'
export const i19dateTime = 'Date and time of the event, in ISO 8601 standard representation'
...
export const i19deliveryIn = 'Your order will be delivered within'
export const i19deliverTrack = 'Delivery Tracking'
...
export const i19discountValue = 'Discount value, percentage or fixed'
...
export const i19emailCartText = 'You can finish it now, while the cart is available.'
export const i19emailCartTitle = 'You did not finish your purchase!'
export const i19emailDeliveredText = 'We hope you have enjoyed shopping with us and will soon visit our website again. The order was delivered to the address below'
export const i19emailDeliveredTitle = 'Your package was delivered!'
export const i19emailInfo = 'Any update to the order will be notified by email, you can also track the progress through'
export const i19emailMarketing = 'Email marketing'
export const i19emails = 'Emails'
export const i19emailShippedText = 'Your package is now with the carrier. To track the delivery progress, go to'
export const i19emailShippedTitle = 'Your package is on the way!'
export const i19emptyCart = 'Your shopping cart is empty'
export const i19enabled = 'Enabled'
export const i19endpoint = 'Endpoint'
export const i19enterYourDocNumber = 'Enter your document number to confirm'
export const i19enterYourEmail = 'Enter your email to proceed'
...
export const i19finalPrice = 'Final price with additional'
...
export const i19giftList = 'Add gift options'
export const i19giftsListInfo = 'Informations about this customer gift list'
export const i19giftsListInfoAuthors = 'Authors of the list'
export const i19giftsListInfoContact = 'Email address or phone number to contact list owners'
export const i19giftsListInfoDescription = 'Short text description for the gift list'
export const i19giftsListInfoEventDate = 'Date and time of the event '
export const i19giftsListInfoNotification = 'Email address to be notified after gift purchase'
export const i19giftsListInfoPermalink = 'URL to gift list page'
export const i19giftsListInfoTitle = 'Title for the gift list'
export const i19giftsListInfoValidThru = 'Validity of the list, until this date the gifts can be bought'
export const i19giftListOwnerID = 'Specify customer ID who will receive the gift'
export const i19giftListWaiting = 'Wait giftlist for purchase'
export const i19giftTo = 'Gift to'
export const i19giftWrap = 'Gift wrap chosen by customer'
...
export const i19identifyAccount = 'Identify your account'
...
export const i19invalidLoginInfo = 'Invalid login info, please verify'
export const i19inventory = 'Inventory'
export const i19inventoryRecords = 'Recent history stock'
export const i19isFilter = 'Filter results'
...
export const i19lastVisitedProducts = 'List of last products visited by customer'
...
export const i19listPayments = 'List payments'
export const i19load = 'Load'
export const i19locale = 'Customer language (pt_br)'
export const i19login = 'Login'
export const i19loginEnabled = 'Login enabled'
export const i19loginError = 'There was an error trying to login, please try again or select another option'
...
export const i19manageStock = 'If true, decrease stock after new order'
export const i19manageYourHistory = 'Manage your purchase history'
export const i19marketing = 'Marketing'
export const i19marketplace = 'Marketplace'
export const i19marketplaces = 'Marketplaces'
export const i19measurement = 'Measure and dimension of your product when users might be interested in price per unit'
export const i19media = 'Media'
export const i19mediaGallery = 'Media gallery'
export const i19metafields = 'List of custom attributes'
export const i19metaTagDescription = 'Meta description tag'
export const i19middleName = 'Middle name'
export const i19minQuantity = 'Minimum quantity to put in cart'
export const i19mlCategoryId = 'ML Category ID'
export const i19mobile = 'Mobile'
export const i19mobileLink = 'Specific to mobile devices'
export const i19modules = 'Modules'
export const i19month = 'Month'
export const i19mostPop = 'Most Popular'
...
export const i19namespace = 'String to help distinguish who (or which app) created and can use this'
...
export const i19notifiedAdmins = 'List of administrators that already seen current status change'
export const i19notifyAboutOrders = 'Notify about progress of the order'
export const i19notes = 'Additional info'
...
export const i19otherCustomers = 'Available to any customers'
export const i19outOfStock = 'Sold Out'
export const i19pageLoaded = 'Page loaded'
export const i19paid = 'Paid'
export const i19paidText = 'We are already separating your package. Soon will be sent.'
...
export const i19priceEffectiveDateEnd = 'Promotion end date and time in ISO 8601 standard representation'
export const i19priceEffectiveDateStar = 'Promotion start date and time in ISO 8601 standard representation'
...
export const i19privateMetafields = 'List of custom attributes, hidden by default, visible for the order buyers'
export const i19product = 'Product'
export const i19productId = 'Product id'
export const i19productImages = 'Product images'
export const i19productionTime = 'Deadline for production or handling of pre-ordered product'
export const i19productionTimeCumulative = 'If the production time is cumulative per product unit'
export const i19productionTimeDays = 'Number of days to post the product after purchase, deadline for production or handling'
export const i19productionTimeMaxTime = 'When cumulative, increase the term proportionally up to this maximum (in days)'
export const i19productionTimeWorkingDays = 'If the deadline is calculated in working days'
export const i19productName = 'Product name'
export const i19products = 'Products'
export const i19productsPurchased = 'Products purchased by customer'
export const i19profileNotFound = 'No profile found with email address'
...
export const i19registerToBuy = 'Complete your registration to proceed with the purchase'
...
export const i19seeCart = 'See shopping cart'
...
export const i19shareWhats = 'Share in to Whatsapp'
export const i19shipped = 'Shipped'
export const i19shippedBy = 'Shipped by'
export const i19shippingAddress = 'Shipping address'
export const i19shippingLineId = 'ID of shipping line related with this event'
export const i19shippingLinesApp = 'Shipping method (by application) chosen by customer'
export const i19shippingLinesCustomFields = 'Custom fields in shipping lines'
export const i19shippingLinesDeclaredValue = 'The package value declared to carrier'
export const i19shippingLinesDeclaredValuePrice = 'Cost for the "declared value" additional service'
export const i19shippingLinesDeliveryTime = 'Estimated delivery time'
export const i19shippingLinesDiscount = 'Discount on shipping price, negative if value was additionated (not discounted)'
export const i19shippingLinesFrom = 'Senders address'
export const i19shippingLinesItems = 'List of order items related with this shipping line, use only if items are divided'
export const i19shippingLinesInvoices = 'List of invoices'
export const i19shippingLinesNotes = 'Optional notes with additional info about this shipping line'
export const i19shippingLinesOtherAdditionals = 'List of other additional services for this shipping line'
export const i19shippingLinesOwnHand = 'Whether the package must be delivered with additional service "own hand"'
export const i19shippingLinesOwnHandPrice = 'Cost for the "own hand" additional service'
export const i19shippingLinesPackage = 'Shipping object information'
export const i19shippingLinesPackageDimensions = 'Object dimensions information'
export const i19shippingLinesPackageWeight = 'Object weight information'
export const i19shippingLinesPostingDeadline = 'Deadline for sending the package'
export const i19shippingLinesPrice = 'Freight cost for this shipping line, without additionals'
export const i19shippingLinesReceipt = 'If the package will be delivered with acknowledgment of receipt'
export const i19shippingLinesReceiptPrice = 'Price of receipt as additional service'
export const i19shippingLinesScheduledDelivery = 'Scheduled delivered'
export const i19shippingLinesStatus = 'Fulfillment status and date of change'
export const i19shippingLinesTaxes = 'List of taxes or other additional services for this shipping line'
export const i19shippingLinesTo = 'Shipping address (recipient)'
export const i19shippingLinesTotalPrice = 'Total cost for this shipping line, with additionals and taxes'
export const i19shippingLinesTrackingCodes = 'List of codes for delivery status follow-up'
export const i19shippingMethod = 'Shipping options'
...
export const i19statusLink = 'URL to order status page, if necessary, use (_id) where order unique ID must appear'
export const i19statusMobileLink = 'URL to order status page for mobile devices'
...
export const i19transactionStatus = 'Data and hour of changed status at transaction'
export const i19transactionType = 'Transaction type'
export const i19trendingApps = 'Trending apps'
export const i19triggers = 'List of events that call this procedure'
...
export const i19unsub = 'Unsubscribe'
...
export const i19wasAnErrorOnLogin = 'There was an error trying to login, please try again or select another option'
export const i19webhooks = 'List of notifications to be sent when this procedure is called. In some properties you can use variables from trigger object with (tr.*) notation, eg.: (tr.body.name)'
export const i19webhooksApi = 'API where notification should be sent'
export const i19webhooksApiExternalApi = 'Use this property if webhook is to any external API (not api.e-com.plus)'
export const i19webhooksApiStoreApi = 'Use this property if webhook is to store API (api.e-com.plus)'
export const i19webhooksMapBody = 'Object to send, it is possible to use variables as properties values'
export const i19webhooksSendBody = 'If true, send body in to notification. If map_body is undefined, trigger object will be sent'
export const i19weight = 'Weight'
export const i19weFrom = 'We from'
export const i19welcome = 'Welcome'
export const i19welcomeText = 'We are happy with your registration. Take a look at our products!'
export const i19weUseYourDataTo = 'We will use your data safely and responsibly to'
