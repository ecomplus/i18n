...
export const i19addVariationText = 'Add variants'
...
export const i19alterationPrice = 'Price alteration'
...
export const i19authorizedStores = 'IDs authorized stores to sell this product'
...
export const i19customizationsOption = 'Option chosen'
...
export const i19errorMsg = 'Unfortunately an error has occurred in your application'
...
export const i19giftsListInfoValidThru = 'Validity of the list'
...
export const i19minQuantity = 'Minimum quantity to put in to cart'
...
export const i19productionTime = 'Deadline for production on pre-ordered product'
export const i19productionTimeCumulative = 'If the production time is cumulative per product unit'
export const i19productionTimeDays = 'Number of days to post the product after purchase'
...
export const i19profileNotFound = 'No profile found with this email address'
...
export const i19requiredField = 'Require field'
...
export const i19shippingLineId = 'ID of shipping line'
export const i19shippingLinesApp = 'Shipping method (by application)'
...
export const i19shippingLinesDiscount = 'Discount on shipping price'
export const i19shippingLinesFrom = 'Senders address'
export const i19shippingLinesItems = 'List of order items related with this shipping line'
export const i19shippingLinesInvoices = 'List of invoices'
export const i19shippingLinesNotes = 'Shipping lines notes'
export const i19shippingLinesOtherAdditionals = 'List of additional services'
export const i19shippingLinesOwnHand = 'Delivered with additional service "own hand"'
...
export const i19shippingLinesPrice = 'Freight cost for this shipping line'
export const i19shippingLinesReceipt = 'Delivered with acknowledgment of receipt'
...
export const i19shippingLinesTaxes = 'List of additional services for this shipping line'
export const i19shippingLinesTo = 'Shipping address (recipient)'
export const i19shippingLinesTotalPrice = 'Total cost for this shipping line'
export const i19shippingLinesTrackingCodes = 'List of codes for delivery status'
...
export const i19transactionStatus = 'Data and hour of changed status'
