...
export const i19aboutCvvMsg = 'Có 3 đến 4 số, thông thường nằm ở phía sau của thẻ (Ở phía trước đối với thẻ AMEX)'
export const i19acceptAttachedFile = 'Chấp nhận file đính kèm'
export const i19acceptCustomOptionByCustomer = 'Chấp nhận bổ sung từ khách hàng'
export const i19activate = 'Kích hoạt'
export const i19active = 'Kích hoạt'
export const i19add = 'Thêm'
export const i19addApp = 'Thêm app'
export const i19addCart = 'Thêm vào giỏ'
export const i19addClient = 'Thêm khách hàng'
