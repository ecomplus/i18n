...
export const i19areYouWantToDeleteAppMsg = 'Tem certeza que deseja excluir o aplicativo?'
...
export const i19deliveryTrack = 'Rastreamento de pedido'
...
export const i19filterResults = 'Resultados do filtro'
...
export const i19hasCouponOrVoucherQn = 'Possui coupom ou vale?'
...
export const i19invoice = 'NFE'
export const i19invoices = 'NFE\'s'
...
export const i19productionTimeDaysMsg = 'Número de dias para postar o produto após a compra, prazo para produção ou manuseio'
...
export const i19shippingAddress = 'Endereço de envio'
...
export const i19uninstallingAppWithSuccessMsg = 'Desinstalando aplicativo com sucesso'
